<template>
    <div class="w-3/6 block bg-gray-100 transition ease-in duration-1000 rounded-r-md p-5 customScroll overflow-y-auto">
        <header class="flex flex-row justify-end items-center">
            <button @click="closeRightSide" type="button" class="p-2 ml-2 text-gray-400 rounded-full hover:text-gray-600 hover:bg-gray-300 focus:outline-none focus:ring">
