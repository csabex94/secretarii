<template>
    <div class="flex flex-col items-stretch justify-start w-full h-full bg-white border-l-2 border-r-2 border-gray-100 lg:rounded-r-md xl:rounded-none">
        <!-- Header with name -->
        <div v-if="$page.props.user.current_team" class="flex flex-row items-center justify-between px-3 py-2 border-b-2 border-gray-100 bg-gray-50 bg-opacity-40">
            <div class="">
                ...
                <p v-if="$page.props.user.current_team.users" class="text-xs text-gray-500">{{ $page.props.user.current_team.users.length }} memebres</p>
            </div>
        ...
        <!-- Input for writing a messages -->
            ...
            <messages :currentTopics="currentTopics" />
        </div>
<!--        <div v-if="showAddTopicForm" class="flex flex-row items-center justify-between p-3">-->
<!--            <div class="">-->
...
<!--                <input type="text" class="w-full px-4 py-1 text-gray-500 border-2 border-gray-100 rounded-full outline-none focus:outline-none focus:ring" placeholder="Write a message...">-->
<!--            </div>-->
<!--            <div class="flex flex-row">-->
